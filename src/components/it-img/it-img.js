...
const It_Img = () => {
    ...
    return (
        <Fragment>
            <div className="it-img_section" style={{ marginBottom: "100px", marginTop: "100px" }}>
                                    ...
                                    <Row>
                                        ...
                                        <Col md={6}>
                                            <div className="content">
                                                <h4>Our Liver Transplant and Biliary Sciences Hospital Network</h4>
                                                ...
                                                <div className="sm_item d-flex">
                                                    ...
                                                    <div className="sm_txt">
                                                        <p>Our <strong>NABH & ISO</strong>  accredited hospitals offer <strong>best in class services to our patients</strong></p>
